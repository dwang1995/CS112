...
public class Set  {
    ...
    public static int size(int[] S) {
        ...
        return Z;   // replace this line; this is just to get it to compile
    }
    ...
    public static int[] add(int k, int[] S) {
        ...
        return M;  // replace this line; this is just to get it to compile
    }
    ...
    public static int[] union(int[] S, int[] T) {
        ...
        return U;  // replace this line; this is just to get it to compile
    } 
    ...
    public static int[] copy_1(int[] S){
    ...
    public static void main(String [] args) {
        ...
        System.out.println("Test 35: Should be:\n{3}"); 
        System.out.println(setToString(SF)); 
        System.out.println(); 
    }
